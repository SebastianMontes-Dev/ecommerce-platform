...
public class CasoUsoCrearProducto {
    ...
    static RespuestaProducto mapToResponse(Producto producto) {
        return RespuestaProducto.builder()
                ...
                .precio(producto.getPrecio() != null ? producto.getPrecio().getMonto() : null)
                .moneda(producto.getPrecio() != null ? producto.getPrecio().getMoneda() : "USD")
                .precioComparacion(producto.getPrecioComparacion() != null ? producto.getPrecioComparacion().getMonto() : null)
                .precioCosto(producto.getPrecioCosto() != null ? producto.getPrecioCosto().getMonto() : null)
                .sku(producto.getSku())
