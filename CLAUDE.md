...
- `./gradlew test` ahora genera un reporte de cobertura JaCoCo en `build/reports/jacoco/test/html/index.html`. CI publica este reporte como artifact `jacoco-coverage-report` en cada run.
